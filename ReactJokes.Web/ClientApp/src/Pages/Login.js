...
return(
    <div className='row'>
        <div className='col-md-6 offset-md-3 card card-body bg-light'>
            ...
            {!isValidLogin && <span className='text-danger'>Invalid username/password</span>}
            <form onSubmit={onFormSubmit}>
                <input onChange={onTextChange} value={formData.email} type='text' name='email' placeholder='email' className='form-control'/><br/>
                <input onChange={onTextChange} value={formData.password} type='text' name='password' placeholder='password' className='form-control'/><br/>
